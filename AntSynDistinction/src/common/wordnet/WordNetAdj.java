...
//			if (synset.synsetType.equals("s")) continue;
	...
	public static void main(String[] args) throws IOException{
		...
		ArrayList<String> antoSuffled = WordNetAdj.getShuffledSynonyms(antoSynoSimNyms[1], antoSynoSimNyms[2]);
        System.out.print("Suffled:");
        System.out.print(antoSuffled + "\n");*/
        
        String[] allAntonyms = wordnetAdj.getAllAntonyms(word);
        System.out.print("All antonyms:\n");
        printStrings(allAntonyms);
        System.out.println("The number of antonyms: " + allAntonyms.length);
        
        String[] allSynonyms = wordnetAdj.getAllSynonyms(word);
        System.out.print("All synonyms:\n");
        printStrings(allSynonyms);
        System.out.println("The number of synonyms: " + allSynonyms.length);
