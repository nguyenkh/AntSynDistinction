...
public class WeightSAWordVectorLearning {
    public static void main(String[] args) throws IOException{
        ...
        String wsFile = properties.getProperty("WSFile");
        String greFile = properties.getProperty("GreFile");
        ...
        switch (type) {
        case 0:
            word2vec = new MultiThreadSkipGram(size, 5, softmax, negativeSamples, subSampling, menFile, wsFile, greFile, iter);
            break;
    
        case 2: 
            word2vec = new WeightSAWord2Vec(size, 5, softmax, negativeSamples, 5, subSampling, menFile, wsFile, greFile, iter);
            if (!(noun || adj || verb)) {
                throw new ValueException("should train with at least one wordnet");
            } else {
                
                WeightSAWord2Vec antoWord2Vec = (WeightSAWord2Vec) word2vec;
                outputFile = outputFile.replaceAll(".bin", "_anto_case2.bin");
